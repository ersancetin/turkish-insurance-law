---
id: kurum-tarsim
baslik: "Tarım Sigortaları Havuzu (TARSİM) — mevzuat ve tarife kararları"
tur: kurum
...
durum: yururlukte
brans: [tarim]
etiketler: [tarim-sigortasi, cumhurbaskani-karari, prim-destegi]
oncelik: 3
kaynaklar:
...
---
# Tarım Sigortaları Havuzu (TARSİM) — mevzuat ve tarife kararları
...
Yıllık Cumhurbaşkanı kararları, tarife ve talimatlar, uygulama esasları.
