---
id: kurum-segem
baslik: "Sigortacılık Eğitim Merkezi (SEGEM) — sınav ve eğitim mevzuatı"
tur: kurum
...
durum: yururlukte
brans: [aracilar]
etiketler: [segem, teknik-personel-sinavi, eksperlik-sinavi, egitim]
oncelik: 3
kaynaklar:
  - "https://www.segem.org.tr"
...
---
# Sigortacılık Eğitim Merkezi (SEGEM) — sınav ve eğitim mevzuatı
...
Acente teknik personeli, eksper ve broker sınav/eğitim düzenlemeleri.
