---
id: gs-zorunlu-koltuk-ferdi-kaza
baslik: "Karayolu Yolcu Taşımacılığı Zorunlu Koltuk Ferdi Kaza Sigortası Genel Şartları"
tur: genel-sart
...
resmi_gazete:
  ...
  sayi: null
durum: yururlukte
brans: [sorumluluk, tasimacilik, ferdi-kaza]
etiketler: [koltuk-ferdi-kaza, yolcu, surucu, muavin]
oncelik: 2
kaynaklar:
...
| Resmî Gazete | — / — |
| Durum | Yürürlükte |
| Branş | sorumluluk, tasimacilik, ferdi-kaza |
| Öncelik | 2 |

## Özet

Yolcu, sürücü ve yardımcıları için ölüm, sakatlık ve tedavi teminatları.
